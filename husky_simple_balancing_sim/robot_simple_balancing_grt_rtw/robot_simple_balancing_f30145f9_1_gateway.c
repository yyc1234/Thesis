...
#include "nesl_rtw.h"
#include "robot_simple_balancing_f30145f9_1.h"
#include "robot_simple_balancing_f30145f9_1_gateway.h"

void robot_simple_balancing_f30145f9_1_gateway(void)
{
  NeModelParameters modelparams = { (NeSolverType) 1, 0.001, 0, 0.001, 0, 0, 0,
    0, (SscLoggingSetting) 0, 504975741, };
  ...
  robot_simple_balancing_f30145f9_1_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group("robot_simple_balancing/Solver Configuration_1",
    1,
    &dae,
    &solverparams,
    &modelparams,
